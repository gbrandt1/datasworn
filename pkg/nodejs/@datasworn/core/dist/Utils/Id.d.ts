...
import type { CollectableAncestorKeys, CollectionAncestorKeys, CollectionPathKeys } from '../IdElements/PathKeys.js';
import type TypeId from '../IdElements/TypeId.js';
import type { Collectable, Collection, NonCollectable, Primary, RulesPackageId } from '../StringId.js';
...
export type ExtractPrimaryPathKeys<T extends Primary> = Split<ExtractPrimaryPath<T>>;
export type ExtractPrimaryKey<T extends Primary> = ExtractPrimaryPathKeys<T> extends [infer U extends string] ? U : ExtractPrimaryPathKeys<T> extends [...string[], infer U extends string] ? U : never;
export type ExtractPrimaryAncestorKeys<T extends Primary> = T extends Collection ? ExtractPrimaryPathKeys<T> extends [
    ...infer U extends PathKeys.CollectionAncestorKeys,
    string
] ? U : T extends Collectable ? ExtractPrimaryPathKeys<T> extends [
    ...infer U extends PathKeys.CollectableAncestorKeys,
    string
] ? U : never : T extends NonCollectable ? [] : never : never;
export type ExtractKey<T extends Primary> = Split<T> extends [
    TypeId.Primary,
    RulesPackageId,
    ...string[],
...
export type ExtractAncestorKeys<T extends Primary> = T extends Collectable ? ExtractCollectionAncestorKeys<T> : T extends Collectable ? ExtractCollectableAncestorKeys<T> : Split<T> extends [
    ...
    string
] ? AncestorKeys : Split<T> extends [RulesPackageId, TypeId.Primary, string] ? [] : never;
export type ExtractParentCollectionKey<T extends Collectable> = Split<T> extends [
    RulesPackageId,
    TypeId.Collectable,
    infer ParentCollectionKey extends string,
    string
] ? ParentCollectionKey : never;
type ExtractCollectionAncestorKeys<T extends Collectable> = Split<T> extends [
    RulesPackageId,
    TypeId.Collection,
    ...infer AncestorKeys extends CollectionAncestorKeys,
    string
] ? AncestorKeys : never;
type ExtractCollectableAncestorKeys<T extends Collectable> = Split<T> extends [
    RulesPackageId,
    TypeId.Collectable,
