...
declare namespace TypeNode {
    export type Collection<T extends TypeId.Collection = TypeId.Collection> = CollectionTypeMap[T];
    export type Collectable<T extends TypeId.Collectable = TypeId.Collectable> = CollectableTypeMap[T];
    export type NonCollectable<T extends TypeId.NonCollectable = TypeId.NonCollectable> = NonCollectableTypeMap[T];
    export type EmbedOnly<T extends TypeId.EmbedOnly = TypeId.EmbedOnly> = EmbedOnlyTypeMap[T];
    export type CollectionSource<T extends TypeId.Collection = TypeId.Collection> = CollectionSourceTypeMap[T];
    export type CollectableSource<T extends TypeId.Collectable = TypeId.Collectable> = CollectableSourceTypeMap[T];
    export type NonCollectableSource<T extends TypeId.NonCollectable = TypeId.NonCollectable> = NonCollectableSourceTypeMap[T];
    export type EmbedOnlySource<T extends TypeId.EmbedOnly = TypeId.EmbedOnly> = EmbedOnlySourceTypeMap[T];
    ...
    type PrimaryTypeMap = CollectionTypeMap & CollectableTypeMap & NonCollectableTypeMap;
    ...
    type EmbedOnlySourceTypeMap = {
        ...
        danger: DataswornSource.DelveSiteThemeDanger | DataswornSource.DelveSiteDomainDanger;
        denizen: DataswornSource.DelveSiteDenizen;
        variant: DataswornSource.NpcVariant;
    };
    type EmbeddableTypeMap = Pick<EmbedOnlyTypeMap & PrimaryTypeMap, TypeId.Embeddable>;
    ...
    export type ByType<T extends keyof PrimaryTypeMap | keyof EmbeddableTypeMap> = T extends keyof PrimaryTypeMap ? T extends keyof EmbeddableTypeMap ? PrimaryTypeMap[T] | EmbeddableTypeMap[T] : PrimaryTypeMap[T] : T extends keyof EmbeddableTypeMap ? EmbeddableTypeMap[T] : never;
    export type BySourceType<T extends keyof PrimarySourceTypeMap | keyof EmbedOnlySourceTypeMap> = T extends keyof PrimarySourceTypeMap ? T extends keyof EmbedOnlySourceTypeMap ? PrimarySourceTypeMap[T] | EmbedOnlySourceTypeMap[T] : PrimarySourceTypeMap[T] : T extends keyof EmbedOnlySourceTypeMap ? EmbedOnlySourceTypeMap[T] : never;
